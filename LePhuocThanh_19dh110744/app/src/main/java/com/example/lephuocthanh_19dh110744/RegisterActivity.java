...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtEmail=findViewById(R.id.editTextext);
        edtUsername=findViewById(R.id.editTextext1);
        edtPassword=findViewById(R.id.editTextext2);
        edtConfirm=findViewById(R.id.editTextext3);
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edtPassword.getText().toString().isEmpty()){
                    edtPassword.setError("Pasword required");
                    return;
                }
                if(edtConfirm.getText().toString().isEmpty()){
                    edtConfirm.setError("Pasword required");
                    return;
                }
